...
public class WorldGenPalaeoraphe extends WorldGenerator
{
    ...
    public boolean generate(World var1, Random var2, int var3, int var4, int var5)
    {
        ...
        for(int y=var4+1;y<=var4+10+deltaY;y++)
            var1.setBlock(var3, y, var5, Fossil.palmLog.blockID);
		 ...
		 var4=var4-5+deltaY;
		    ...
		    var1.setBlock(var3, var4 + 16, var5, Fossil.palmLeaves.blockID);
            var1.setBlock(var3 + 1, var4 + 15, var5, Fossil.palmLeaves.blockID);
            var1.setBlock(var3 + 2, var4 + 15, var5, Fossil.palmLeaves.blockID);
            var1.setBlock(var3 + 3, var4 + 15, var5, Fossil.palmLeaves.blockID);
            var1.setBlock(var3 + 4, var4 + 15, var5, Fossil.palmLeaves.blockID);
            var1.setBlock(var3 + 5, var4 + 14, var5, Fossil.palmLeaves.blockID);
            var1.setBlock(var3, var4 + 15, var5 + 1, Fossil.palmLeaves.blockID);
            var1.setBlock(var3, var4 + 15, var5 + 2, Fossil.palmLeaves.blockID);
            var1.setBlock(var3, var4 + 15, var5 + 3, Fossil.palmLeaves.blockID);
            var1.setBlock(var3, var4 + 15, var5 + 4, Fossil.palmLeaves.blockID);
            var1.setBlock(var3, var4 + 14, var5 + 5, Fossil.palmLeaves.blockID);
            var1.setBlock(var3 - 1, var4 + 15, var5, Fossil.palmLeaves.blockID);
            var1.setBlock(var3 - 2, var4 + 15, var5, Fossil.palmLeaves.blockID);
            var1.setBlock(var3 - 3, var4 + 15, var5, Fossil.palmLeaves.blockID);
            var1.setBlock(var3 - 4, var4 + 15, var5, Fossil.palmLeaves.blockID);
            ...
            var1.setBlock(var3, var4 + 15, var5 - 4, Fossil.palmLeaves.blockID);
            var1.setBlock(var3, var4 + 14, var5 - 5, Fossil.palmLeaves.blockID);
            var1.setBlock(var3 + 1, var4 + 15, var5 + 1, Fossil.palmLeaves.blockID);
            var1.setBlock(var3 + 1, var4 + 15, var5 - 1, Fossil.palmLeaves.blockID);
            var1.setBlock(var3 - 1, var4 + 15, var5 + 1, Fossil.palmLeaves.blockID);
            var1.setBlock(var3 - 1, var4 + 15, var5 - 1, Fossil.palmLeaves.blockID);
            var1.setBlock(var3 + 2, var4 + 15, var5 + 2, Fossil.palmLeaves.blockID);
            var1.setBlock(var3 + 2, var4 + 15, var5 - 2, Fossil.palmLeaves.blockID);
            var1.setBlock(var3 - 2, var4 + 15, var5 + 2, Fossil.palmLeaves.blockID);
            var1.setBlock(var3 - 2, var4 + 15, var5 - 2, Fossil.palmLeaves.blockID);
            var1.setBlock(var3 + 3, var4 + 14, var5 + 3, Fossil.palmLeaves.blockID);
            var1.setBlock(var3 + 3, var4 + 14, var5 - 3, Fossil.palmLeaves.blockID);
            var1.setBlock(var3 - 3, var4 + 14, var5 + 3, Fossil.palmLeaves.blockID);
            var1.setBlock(var3 - 3, var4 + 14, var5 - 3, Fossil.palmLeaves.blockID);
