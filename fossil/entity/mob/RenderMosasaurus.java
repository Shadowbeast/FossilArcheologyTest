...
public class RenderMosasaurus extends RenderLiving
{
    ...
    {
        EntityMosasaurus var4 = (EntityMosasaurus)var1;
        return this.setHungryEyesBrightness(var4, var2, var3);
    }

    public int setHungryEyesBrightness(EntityMosasaurus var1, int var2, float var3)
    {
        if (var2 != 0)
        {
            return -1;
    ...
    {
        this.renderCow((EntityMosasaurus)var1, var2, var4, var6, var8, var9);
    }
    ...
    public void renderCow(EntityMosasaurus var1, double var2, double var4, double var6, float var8, float var9)
    {
        GL11.glPushMatrix();
